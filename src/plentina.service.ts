...
export class PlentinaService {
   ...
   */
  healthCheck(): string {
    return 'Raj Kishorbhai Savaliya';
  }
   ...
   * @param w1 width of the rectangle
   * @param h1 height of the rectangle
   * @param x2 x-coordinate of the center of line
   * @param y2 y-coordinate of the center of line
   * @param w2 width of the line
   * @returns a boolean if they collide or not
   */
  doesRectAndLineCollide(
    ...
    const rect1 = new Rect(x1, y1, w1, h1);
    const line = new Line(x2, y2, w2);

    return rect1.collides(line);
  }
  /**
   * Checks if a rectangle and a second rectangle collide
   * @param x1 x-coordinate of the circle
  ...
  doesCircleAndLineCollide(
    ...
    const circle = new Circle(x1, y1, w1);
    const line = new Line(x2, y2, w2);
  ...
  /**
   * Checks if a rectangle and a second rectangle collide
   * @param x1 x-coordinate of the center of line
   * @param y2 y-coordinate of the center of line
   * @param w1 width of the line
   * @param x2 x-coordinate of the center of line
   * @param y2 y-coordinate of the center of line
   * @param w2 width of the line
   * @returns a boolean if they collide or not
  ...
  doesLineAndLineCollide(
    ...
    const line1 = new Line(x1, y1, w1);
    const line2 = new Line(x2, y2, w2);
